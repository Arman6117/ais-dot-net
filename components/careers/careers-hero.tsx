...
export default function CareersHero() {
  ...
  return (
    <section className={`${instrumentSerif.variable} relative min-h-[65vh] flex flex-col justify-end px-5 sm:px-8 lg:px-[52px] pb-20 pt-40 overflow-hidden`}>
      <div className="absolute top-1/3 right-1/4 w-[500px] h-[300px] blur-[120px] opacity-[0.06] pointer-events-none"
      ...
      <div ref={subRef} className="opacity-0 max-w-[500px] mb-8">
        <p className="text-[0.9rem] text-black/50 leading-[1.8]">
          Join AIS Solutions as a paid intern. Work on real projects, get mentored by experts, and earn a stipend of ₹3,000–₹6,000/month.
        </p>
      </div>

      <div ref={badgesRef} className="opacity-0 flex flex-wrap gap-3">
        {["₹3,000–₹6,000 Stipend", "3–6 Months", "Master's Graduates", "Expert Mentorship"].map((b) => (
          <div key={b}
