...
export default function ServiceCategories() {
  ...
  return (
    ...
    >
      {/* Glow */}
      <div
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] blur-[140px] opacity-[0.04] pointer-events-none"
              ...
              <div className="p-8 sm:p-10 flex flex-col gap-7 flex-1">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <h3 className="font-[family-name:var(--font-serif)] italic text-[1.8rem] leading-[1] tracking-[-0.02em] text-white">
                      {title}
                    </h3>
                  </div>
                </div>
                ...
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-3">
                  {features.map((f) => (
                    <li key={f} className="flex items-center gap-3">
                      ...
                      <span className="text-[0.8rem] text-white/65 font-medium">
                        {f}
                      </span>
                    </li>
                  ))}
