...
export default function AboutHero() {
  ...
  return (
    <section
      className={`${instrumentSerif.variable} relative min-h-[70vh] flex flex-col justify-end px-5 sm:px-8 lg:px-[52px] pb-20 pt-40 overflow-hidden`}
    >
      {/* Background grid — inherited from layout */}
      {/* Subtle blue glow bottom left */}
      <div
        className="absolute bottom-0 left-0 w-[500px] h-[300px] blur-[120px] opacity-[0.07] pointer-events-none"
      ...
      {/* Subtext */}
      <div ref={subRef} className="opacity-0 max-w-[520px]">
        <p className="text-[0.9rem] text-black/50 leading-[1.8]">
          AIS Solutions Pvt. Ltd. was founded with one belief — that every scholar, every business, and every idea deserves the right data partner. From Pune to the world.
        </p>
      </div>
    </section>
  );
