...
export default function ContactHero() {
  ...
  return (
    <section className={`${instrumentSerif.variable} relative min-h-[60vh] flex flex-col justify-end px-5 sm:px-8 lg:px-[52px] pb-20 pt-40 overflow-hidden`}>
      {/* Glow */}
      <div className="absolute top-1/2 left-1/4 w-[500px] h-[300px] blur-[120px] opacity-[0.06] pointer-events-none"
      ...
      <div ref={subRef} className="opacity-0 max-w-[480px]">
        <p className="text-[0.9rem] text-black/50 leading-[1.8]">
          Whether you&apos;re a PhD scholar, a business, or just exploring — we&apos;re here. Reach out and we&apos;ll get back to you shortly.
        </p>
      </div>
    </section>
  );
